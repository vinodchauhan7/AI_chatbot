...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[670px] w-[350px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden mt-52">
        ...
        <div className="flex justify-center ">
          <p className="text-gray-400 text-xs">Powered By AI-BOT</p>
        </div>
      </div>
    )
  }
